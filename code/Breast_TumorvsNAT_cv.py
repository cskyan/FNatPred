...
results_cv = []  # Store the results for each model
...
total_samples = X_train.shape[0]        # Calculate the total number of rows
...
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
print("Before saving roc_df to CSV")
output_file = os.path.join(output_folder, 'results_cv_Breast.csv')
