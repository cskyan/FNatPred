...
folder_path0 = 'data/1vsALL/1vsALL__weizmannSpecies'
...
for i, filename in enumerate(sorted(os.listdir(folder_path))):
    ...
    if train_datay is not None and train_datax is not None:
        ...
        train_data_y_encoded = [0 if label == "OtherCancerType" else 1 for label in train_data_y]
        ...
        X_train1, X_test1, y_train1, y_test1 = train_test_split(train_data_X, train_data_y_encoded_series, test_size=0.5,
                                                            ...
                                                            random_state=42)
        # print("Features after sampling：", X_train1.head(10))
        # print("Labels after sampling：", y_train1.head(10))
        # print("Validation set：", X_test1.head(10))
        # print("Validation set labels：", y_test1.head(10))

        ### Initialize the table:oof
        ...
        print("Initialize test_output_df", test_output_df)
...
#             print("valid_y:", valid_y)
        ...
        x_data_train, x_data_test, y_data_train, y_data_test = train_test_split(test_output_df, y_test1, test_size=0.2,
                                                                                stratify=y_test1, random_state=42)
        ...
        model_names = ['XGBoost', 'CatBoost', 'LightGBM', 'Random Forest', 'Fmodel']
...
output_file = os.path.join(output_folder, '1vsall_fmodelvsothers_values.csv')
