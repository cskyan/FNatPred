...
train_datax = pd.read_csv(file_path + '/breast -- tumor vs nat -- Features.csv')
train_datay = pd.read_csv(file_path + '/breast -- tumor vs nat -- trainY.csv')
...
total_samples = train_data_X.shape[0]        #Calculate the total number of rows
split_index = total_samples // 2
X_train1 = train_data_X[:split_index]
X_test1 = train_data_X[split_index:]
...
###############################roc auc##################################
plt.title('Tumor vs NAT | Species Level | Breast')
...
plt.savefig('breast_multi_models_roc.png')
plt.show()

# plt.xlabel('Recall')
# plt.ylabel('Precision')
# plt.title('Precision-Recall Curve |Tumor vs NAT | Species Level | Breast')
# plt.plot([0, 1], [1, 0], 'r--')
# plt.xlim([0.0, 1.0])
# plt.ylim([0.0, 1.0])
# plt.legend(loc='lower right')
# plt.grid(True)
# plt.savefig('Breast_multi_models_pr.png')
# plt.show()
